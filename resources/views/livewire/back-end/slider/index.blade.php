        ...
        <div class="table-responsive">
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                <thead class="bg-200 text-900">
                    <tr>
                        <th class="sort pe-1 align-middle white-space-nowrap">Slider Title</th>
                        <th class="sort pe-1 align-middle white-space-nowrap">description</th>
                        ...
                        <tr class="btn-reveal-trigger">
                            <td class="name align-middle white-space-nowrap py-2">
                                <div class="d-flex d-flex align-items-center">
                                    <div class="avatar avatar-xl me-2">
                                        @if ($item->image)
                                            <img class="rounded-circle"
                                                src="{{ asset('storage/Attachments/Slider-Attachments/' . $item->image) }}"
                                                alt="{{ $item->name }}" />
                                        @else
                                            <img class="rounded-circle"
                                    ...
                                    <div class="flex-1">
                                        <h5 class="mb-0 fs--1">{{ $item->title }}</h5>
                                    </div>
                                </div>
                            </td>
                            <td class="phone align-middle white-space-nowrap py-2">{{ $item->description }}</td>
                                ...
                                <div class="dropdown font-sans-serif position-static">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end border py-0"
                                        ...
                                        <div class="bg-white py-2"><a class="dropdown-item"
                                            ...
                                            data-bs-target="#destorySlider{{ $item->id }}">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </td>
                        </tr>
                        @include('pages.backend.slider.modal.delete')
                    @empty
                    <tr>
