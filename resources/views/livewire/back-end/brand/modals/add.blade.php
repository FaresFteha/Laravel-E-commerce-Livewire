<div wire:ignore.self class="modal fade" id="AddBrand" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body p-0">
                ...
                <div class="p-4 pb-0">
                    <form wire:submit.prevent="store()">
                        ...
                        <div class="mb-3">
                            <input class="form-check-input" id="gridCheck" wire:model.defer="status" type="checkbox" />
