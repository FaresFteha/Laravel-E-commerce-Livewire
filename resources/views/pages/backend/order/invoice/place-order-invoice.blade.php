...
<body>
        ...
        <thead>
            <tr>
                <th width="50%" colspan="2">
                    <h2 class="text-start">Tech Ecommerce</h2>
                </th>
                <th width="50%" colspan="2" class="text-end company-data">
                    <span>Invoice Id: {{ $order->id }} </span> <br>
                    <span>Date: {{ date('d / m / Y') }}</span> <br>
                    <span>Zip code : 560077</span> <br>
                    <span>Address: #555, Khanyounes, Gaza, Palestine</span> <br>
                </th>
            </tr>
            <tr class="bg-blue">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2" class="total-heading">${{ $totalPrice }}</td>
            </tr>
        </tbody>
    </table>
    ...
    <br>
    <p class="text-center">
        Thank your for shopping with Tech Ecommerce
    </p>
